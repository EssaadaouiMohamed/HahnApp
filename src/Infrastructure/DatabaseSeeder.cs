...
using HahnApp.Infrastructure.Helpers;
using HahnApp.Infrastructure.Models.Identity;
using HahnApp.Shared.Constants.Permission;
using HahnApp.Shared.Constants.Role;
using HahnApp.Shared.Constants.User;
    ...
    public class DatabaseSeeder : IDatabaseSeeder
    {
        ...
        private void AddAdministrator()
        {
            Task.Run(async () =>
            {
                ...
                var adminRole = new CustomRole(RoleConstants.AdministratorRole, _localizer["Administrator role with full permissions"]);
        ...
        private void AddBasicUser()
        {
            ...
            {
                //Check if Role Exists
                var basicRole = new CustomRole(RoleConstants.BasicRole, _localizer["Basic role with default permissions"]);
                ...
                //Check if User Exists
                var basicUser = new CustomUser
                {
                    FirstName = "Wael",
                    LastName = "Boutzougarte",
                    Email = "boutzougarte@gmail.com",
                    UserName = "Wboutzo",
                    EmailConfirmed = true,
                    PhoneNumberConfirmed = true,
                    CreatedOn = DateTime.Now,
