...
using AutoMapper;
using HahnApp.Application.Exceptions;
...
using HahnApp.Infrastructure.Specifications;
...
namespace HahnApp.Infrastructure.Services.Identity
{
    public class UserService : IUserService
    {
        ...
        private async Task<string> SendVerificationEmail(CustomUser user, string origin)
        {
        ...
        public async Task<IResult> UpdateRolesAsync(UpdateUserRolesRequest request)
        {
            ...
            if (user.Email == "mohamedessaadaoui02@gmail.com")
            {
        ...
        public async Task<string> ExportToExcelAsync(string searchString = "")
        {
            ...
            var result = await _excelService.ExportAsync(users, sheetName: _localizer["Users"],
                mappers: new Dictionary<string, Func<CustomUser, object>>
                {
