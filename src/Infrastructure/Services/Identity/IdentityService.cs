...
namespace HahnApp.Infrastructure.Services.Identity
{
    public class IdentityService : ITokenService
    {
        ...
        public IdentityService(
            ...
            IOptions<AppConfiguration> appConfig, SignInManager<CustomUser> signInManager,
        ...
        private async Task<string> GenerateJwtAsync(CustomUser user)
        {
            var token = GenerateEncryptedToken(GetSigningCredentials(), await GetClaimsAsync(user));
            return token;
        }

        private async Task<IEnumerable<Claim>> GetClaimsAsync(CustomUser user)
        {
