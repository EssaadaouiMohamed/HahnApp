...
{
    public abstract class AuditableContext : IdentityDbContext<CustomUser, CustomRole, string, IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, CustomRoleClaim, IdentityUserToken<string>>
    {
