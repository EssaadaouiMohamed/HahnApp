...
namespace HahnApp.Infrastructure.Helpers
{
    public static class ClaimsHelper
    {
        ...
        public static async Task<IdentityResult> AddPermissionClaim(this RoleManager<CustomRole> roleManager, CustomRole role, string permission)
        {
